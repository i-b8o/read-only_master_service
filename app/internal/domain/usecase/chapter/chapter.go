...
func NewChapterUsecase(chapterService ChapterService, paragraphService ParagraphService, linkService LinkService, regulationService RegulationService) *chapterUsecase {
	return &chapterUsecase{chapterService: chapterService, paragraphService: paragraphService, linkService: linkService, regulationService: regulationService}
}
