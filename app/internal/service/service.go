...
type RegulationSupremeGRPCServce struct {
	regulationStorage RegulationStorage
	chapterStorage    ChapterStorage
	paragraphStorage  ParagraphStorage
	logging           logging.Logger
	pb.UnimplementedRegulationSupremeGRPCServer
}

func NewRegulationSupremeGRPCService(regulationStorage RegulationStorage, chapterStorage ChapterStorage, paragraphStorage ParagraphStorage, loging logging.Logger) *RegulationSupremeGRPCServce {
	return &RegulationSupremeGRPCServce{
		regulationStorage: regulationStorage,
		chapterStorage:    chapterStorage,
		paragraphStorage:  paragraphStorage,
		logging:           loging,
...
func (s *RegulationSupremeGRPCServce) CreateRegulation(ctx context.Context, req *pb.Regulation) (*pb.ID, error) {
...
func (s *RegulationSupremeGRPCServce) DeleteRegulation(ctx context.Context, req *pb.ID) (*pb.Status, error) {
	ID := req.GetID()
...
func (s *RegulationSupremeGRPCServce) CreateChapter(ctx context.Context, req *pb.Chapter) (*pb.ID, error) {
...
func (s *RegulationSupremeGRPCServce) DeleteChaptersForRegulation(ctx context.Context, req *pb.ID) (*pb.Status, error) {
	ID := req.GetID()
...
func (s *RegulationSupremeGRPCServce) CreateAllParagraphs(ctx context.Context, req *pb.Paragraphs) (*pb.Status, error) {
...
func (s *RegulationSupremeGRPCServce) UpdateOneParagraph(ctx context.Context, req *pb.UpdateOneRequestMesssage) (*pb.Status, error) {
	ID := req.GetID()
...
func (s *RegulationSupremeGRPCServce) DeleteParagraphsForChapter(ctx context.Context, req *pb.ID) (*pb.Status, error) {
	ID := req.GetID()
